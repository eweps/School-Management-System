<section>
    ...
    <form method="post" action="{{ route('admin.departments.update', $department->id) }}" class="mt-6 space-y-6">
        @csrf
        @method('patch')
        ...
        <div class="">
            <div class="w-full">
                ...
                <x-textarea id="description" name="description" class="mt-1 block w-full">{{ old('description', $department->description) }}</x-textarea>
