<x-app-layout pageTitle="All Teacher Courses">
    <x-slot name="header">
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <header class="mb-8 dark:text-neutral-200 uppercase tracking-wider font-semibold">
                <h1 class="text-base">Dashboard / <a href="{{ route('admin.teachers.courses', $teacher->id) }}"
                        class="text-secondary">Courses for {{ $teacher->user->name }}</a>
                </h1>
            </header>
            ...
            <div class="w-full overflow-x-auto py-5 px-4 bg-white dark:bg-gray-800 shadow rounded-lg mb-8">
                <div class="max-w-xl">
                    @include('dashboard.admin.teachers.partials.add-course-to-teacher-form')
                </div>
            </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="flex flex-col md:flex-row justify-center items-center gap-3">
                                            ...
                                            <form action="{{ route('admin.teachers.courses.remove') }}"
                                                method="POST">
                                                @csrf
