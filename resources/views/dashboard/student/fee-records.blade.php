    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <header class="mb-8 dark:text-neutral-200 uppercase tracking-wider font-semibold">
                <h1 class="text-base">Dashboard / <a href="{{ route('student.fee-records') }}" class="text-secondary">Fee Records</a></h1>
            </header>
                            ...
                            <td>
                                <div class="flex flex-col md:flex-row justify-center items-center gap-3">
                                    ...
                                    <x-view-modal key="{{ $feeRecord->id }}" heading="Fee Record Details" button="More">
                                      ...
                                      <x-primary-linkbutton href="{{ route('student.fee-records.download', $feeRecord->id) }}">
