    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <header class="mb-8 dark:text-neutral-200 uppercase tracking-wider font-semibold">
                <h1 class="text-base">Dashboard / <a href="{{ route('student.resources') }}" class="text-secondary">Learning Resources</a>
                </h1>
            </header>
                        ...
                        @isset($resources)
                            ...
                            @foreach ($resources as $resource)
                                <tr>
                                    ...
                                    <td>{{ $resource->name }}</td>
                                    <td>{{ $resource->teacher->user->name }}</td>
                                    ...
                                    <td>
                                        <div class="flex flex-col md:flex-row justify-center items-center gap-3">
                                            ...
                                            <x-primary-linkbutton href="{{ route('student.resources.download', $resource->id) }}">
