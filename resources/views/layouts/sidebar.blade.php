    ...
    <ul id="sidebar-nav" class="mb-20 space-y-4">
        ...
        <li class="nav-dropdown mb-2 group">
            ...
            <ul class="dropdown pl-7 mt-6 hidden">
                <li class="mb-4 group">
                    <a href="#"
                        class="text-gray-300 text-lg flex item-center before:h-1 before:rounded-full before:bg-gray-300 before:mr-3 group-[.active]:text-primary-lightest group-[.active]:font-bold">All
                        Teachers</a>
                </li>
                <li class="mb-4 group">
                    <a href="#"
                        class="text-gray-300 text-lg flex item-center before:h-1 before:rounded-full before:bg-gray-300 before:mr-3 group-[.active]:text-primary-lightest group-[.active]:font-bold">Add
                        Teacher</a>
                </li>
            </ul>
        ...
        <li class="nav-dropdown mb-2 group">
            ...
            <ul class="dropdown pl-7 mt-6 hidden">
                ...
                <li class="mb-4 group">
                    <a href="#"
                        class="text-gray-300 text-lg flex item-center before:h-1 before:rounded-full before:bg-gray-300 before:mr-3 group-[.active]:text-primary-lightest group-[.active]:font-bold">Registered
                        Students</a>
                </li>
                <li class="mb-4 group">
                    <a href="#"
        ...
        <li class="nav-dropdown mb-2 group {{ request()->routeIs('admin.departments*') ? 'active' : '' }}">
            <a href="#"
                class="text-gray-300 hover:text-white flex items-center gap-3 text-lg font-medium py-2 px-3 rounded-lg group-[.active]:bg-primary-light group-[.active]:text-white group-[.selected]:bg-primary-light group-[.selected]:text-gray-100 hover:bg-primary-lighter">
        ...
        <li class="nav-dropdown mb-2 group/item">
            ...
            <ul class="dropdown pl-7 mt-6 hidden">
                <li class="mb-4 group">
                    <a href="#"
                        class="text-gray-300 text-lg flex item-center before:h-1 before:rounded-full before:bg-gray-300 before:mr-3 group-[.active]/item:text-primary-lightest group-[.active]:font-bold">General
                        Settings</a>
                </li>
                <li class="mb-4">
                    <a href="#"
