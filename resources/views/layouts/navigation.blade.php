...
<nav class="nav py-2 px-8 bg-primary dark:bg-primary-dark flex items-center justify-between border-b border-b-neutral-100 sticky top-0 z-20">
 ...
 <div class="hidden sm:flex sm:items-center sm:ms-6">
    <x-dropdown align="right" width="48">
        <x-slot name="trigger">
            ...
            <button type="button" class="flex items-center gap-2 border border-neutral-100 py-2 px-3 rounded-lg text-white">
