...
<body>
    <div class="wrapper">
        <div class="container">
            ...
            <table>
                ...
                <tr>
                    <td colspan="3" class="py-8">&nbsp;</td>
                    <td colspan="2" class="py-8">&nbsp;</td>
                </tr>
    ...
    <!-- Footer -->
    <div class="footer">
         Generated by {{ config('app.name') }} on {{ now()->setTimezone(auth()->user()->timezone)->format('Y-m-d') }} at {{ now()->setTimezone(auth()->user()->timezone)->format('H:i a') }}
    </div>
</body>
</html>
